...
def process_image(image):
    ...
    np_image_temp = np.array(im)
    np_image_temp = np_image_temp.astype('float64')
    np_image_temp = np_image_temp / [255,255,255]
    np_image = (np_image_temp - [0.485, 0.456, 0.406])/ [0.229, 0.224, 0.225]
    np_image = np_image_temp.transpose((2, 0, 1))
    return np_image
...
def parse():
    parser = argparse.ArgumentParser(description='VGG network to Classify Image')
